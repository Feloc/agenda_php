<?php
  class ConectorBD
  {
    ...
    private $password;
    private $conexion;
    //se crea un constructor para la clase en elquenicializamos los datos de la coleccion
    //de esta manera cada vez que creemos un objeto de esta clase podemos especificar el usuario con el que haremos la conexion
    ...
    function eliminarRegistro($tabla, $event_id){
      $sql = "DELETE FROM ".$tabla." WHERE id = ".$event_id.";";
      return $this->ejecutarQuery($sql);
      //echo $sql;
    }
